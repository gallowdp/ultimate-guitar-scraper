...
function formatSearchQuery (query) {
  let params = {}
  let acceptedParams = ['query', 'type', 'page', 'min_rating']
  ...
  // rating[0] and rating[1] params limit results based on range of stars
  if (Number.isInteger(query.minRating)) {
    params['rating[0]'] = query.minRating
    params['rating[1]'] = 5
  }
